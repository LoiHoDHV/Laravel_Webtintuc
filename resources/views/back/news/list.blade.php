    ...
    <div class="card card-primary">
        <div class="row">
            <div class=" card-header col-md-6">
                ...
                <a href="{{url('admin/news/add')}}" class="btn btn-block btn-primary" title="Thêm nhân viên" class="">
                    Thêm
                    tin tức</a>
            ...
            <div class=" card-header col-md-6">
                ...
                <form action="{{url('/admin/news/search')}}" method = "POST">
                    ...
                    <div class="input-group">
                        <input type="search" class="form-control form-control-lg" placeholder="Tìm kiếm theo tên bài viết" name = "keyword">
        ...
        <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid"
            ...
            <tbody>
                ...
                <tr class="odd">
                    ...
                    <td class="dtr-control sorting_1"> <a href = "{{url('/'.$v->Alias .'.html')}}" target="_blank"> {{$v->Name}} </a></td>
